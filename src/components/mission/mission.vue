                        ...
                        <n-flex :justify="'center'">
                            <n-flex vertical>
                                <n-image style="border-radius: 12px" :width="240"
                                    src="./skill_angola/mission/WechatIMG5.webp" preview-disabled></n-image>
                                <n-flex :justify="'center'">
                ...
                <n-grid class="block3__inner" :y-gap="256">
                    <n-gi class="showdetail" :span="12">
                        <n-flex :justify="'center'">
                            <n-flex vertical>
                                <n-image style="border-radius: 12px" :width="240"
                                    src="./skill_angola/mission/redlight.webp" preview-disabled></n-image>
                            </n-flex>
                        </n-flex>
                    </n-gi>
                    <n-gi :span="12">
                ...
                <n-grid class="block4__inner" :y-gap="256">
                    <n-gi class="showdetail" :span="12">
                        <n-flex :justify="'center'">
                            <n-flex vertical>
                                <n-image style="border-radius: 12px" :width="240"
                                    src="./skill_angola/mission/greenlight.webp" preview-disabled></n-image>
                            </n-flex>
                        </n-flex>
                    </n-gi>
                    <n-gi :span="12">
